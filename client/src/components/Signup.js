...
function Signup() {
  ...
  async function emailValidationCheck(e) {
    ...
    // }
    await axios(
      'http://ec2-3-35-140-107.ap-northeast-2.compute.amazonaws.com:8080/email-duplication-check/' + userinfo.email,
      {
        method: 'GET',
        headers: {
          'Access-Control-Allow-Headers': 'Content-Type',
    ...
    <div id="container">
      ...
      <div id="content">
        <div class="row_group">
          ...
          <span class="input_box">
            <input id="password" class="int" type="password" onChange={handleInputValue('password')}></input>
          </span>
          <h3>
          ...
          <span class="input_box">
            <input type="text" id="password_check" class="int" onChange={checkingPassword}></input>
          </span>
        </div>
        <div class="row_group">
          <h3>
